...
def construct_model_base(model_path: str) -> ModelBase:
    ...
    if 'qwen' in model_path.lower():
        from src.refusal_direction.pipeline.model_utils.qwen_model import QwenModel
        return QwenModel(model_path)
    if 'llama-3' in model_path.lower():
        from src.refusal_direction.pipeline.model_utils.llama3_model import Llama3Model
